  ...
  return (
    <Card className="flex overflow-hidden flex-col shadow-md rounded-lg bg-white/90 backdrop-blur-lg bg-opacity-80 hover:shadow-xl transition-transform duration-300 transform hover:scale-105">
      ...
      <CardHeader className="p-4 text-center">
        ...
        <CardDescription className="text-sm text-gray-500">{formatCurrency(priceInCents)}</CardDescription>
      </CardHeader>
      <CardContent className="flex-grow p-4">
        <p className="line-clamp-3 text-justify text-sm text-gray-700">{description}</p>
      </CardContent>
