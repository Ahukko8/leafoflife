    ...
    <section className="relative h-screen flex items-center bg-[url(/img/bg.jpg)] ">
      <div className=" container mx-auto flex flex-col md:flex-row items-center justify-between p-6">
        <div className="p-20 flex-1 text-center md:text-left ">
          <h2 className="text-green-800 lg:text-2xl md:text-2xl sm:text-xl max-sm:text-xl">
            Your Herbal Clininc
          </h2>
          <h1 className="font-bold text-gray-800 leading-tight lg:text-6xl md:text-5xl sm:text-5xl max-sm:text-5xl">
            Leaf of Life Clinic
          </h1>
          <p className="mt-4 text-gray-600 max-w-screen-sm md:text-2xl sm:text-xl max-sm:text-lg leading-relaxed max-sm:leading-normal">
